...
if ($gambar_barang  != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        $query = "INSERT INTO barang (nama_barang,gambar_barang) VALUES ('$nama_barang','$nama_gambar_baru')";
    ...
    $query = "INSERT INTO barang (nama_barang,gambar_barang) VALUES ('$nama_barang', null)";
    $result = mysqli_query($koneksi, $query);
    // periska query apakah ada error
    if (!$result) {
        die("Query gagal dijalankan: " . mysqli_errno($koneksi) .
